...
class TicTacToe:
    ...
    def winner(self,square,letter):
        # winner if 3 in a row....or anywhere
        #row
        row_ind = square//3
...
def play(game, x_player, o_player, print_game = True):
    ...
    while game.empty_squares():
        ...
        # tiny break to make things clear
        if print_game:
            time.sleep(0.8)
...
if __name__ == '__main__':
    ...
    print(f'After 500 iterations, we see {x_wins} x_wins, {o_wins} o_wins, and {tie} ties')
